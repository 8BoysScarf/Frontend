  ...
  template: `
    ...
    <aside
      class="fixed inset-y-0 start-0 z-[60] w-72 flex flex-col
             ...
             lg:translate-x-0 lg:static lg:h-screen lg:shadow-none shadow-2xl shadow-slate-900/50"
      ...
      <div class="p-4 border-t border-white/10 space-y-2">
        <button (click)="langService.toggleLang()"
          class="w-full px-4 py-3 rounded-xl border border-white/10 text-[10px] font-black text-white/50 uppercase tracking-[0.2em] hover:bg-white/10 hover:text-white transition-all flex items-center justify-center gap-2">
        ...
        <button (click)="onLogout()"
          class="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-rose-400 hover:bg-rose-500/10 hover:text-rose-300 transition-all group">
          <svg class="w-5 h-5 shrink-0 group-hover:rotate-12 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
